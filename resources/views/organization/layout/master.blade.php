                        ...
                        <li>
                            <div class="dropdown-user-box">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" <?php if(Auth::user()->logo_img == NULL){ ?>src="<?=asset('img/logo/organization-default-logo.png') ?>" <?php }else{ ?> src="<?=asset('uploads') ?>/{{Auth::user()->logo_img}}" <?php }?>>
                                </a>
