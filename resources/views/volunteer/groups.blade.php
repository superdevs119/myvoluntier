            ...
            <div class="row">
                <div class="col-lg-12 animated fadeInRight impact-panel" style="margin-top: 0">
                    <div class="impact-tracked-hours">
                        <a href="{{url('volunteer/group/group_add')}}" class="btn btn-primary"><i class="fa fa-plus"></i> Create Group</a>
                        {{--<a href="{{url('volunteer/group/group_search')}}" class="btn btn-primary"><i class="fa fa-search"></i> Discover Group</a>--}}
                    </div>
