                                            ...
                                            <td style="text-align: left; padding-left: 50px">
                                                @if($r['logo_img'] == null)
                                                    ...
                                                    @elseif($r['user_role'] == 'group')
                                                        <a href="{{url('/')}}/volunteer/group/view_group_detail/{{$r['id']}}" target="_blank">
        ...
        @section('script')
            ...
            <script>
                ...
                $('.btn-action-follow').on('click',function () {
                    ...
                    if(user_type == 'group'){
                        var url = API_URL + 'volunteer/followGroup';
                    }else{
                ...
                $('.btn-action-unfollow').on('click',function () {
                    var user_type = $(this).parent().parent().find('.current-type').val();
                    if(user_type == 'group'){
                        var url = API_URL + 'volunteer/unfollowGroup';
                    }else{
                ...
                $('.btn-action-connect').on('click',function () {
                    var user_type = $(this).parent().parent().find('.current-type').val();
                    if(user_type == 'group'){
                        var url = API_URL + 'volunteer/jointoGroup';
                    }else{
